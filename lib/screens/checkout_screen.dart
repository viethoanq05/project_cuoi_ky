...
class _CheckoutScreenState extends State<CheckoutScreen> {
        ...
        child: Column(
          children: const [
            RadioListTile<String>(
              title: Text('Deliver now'),
              subtitle: Text('Within 30-45 minutes'),
              value: 'now',
            ),
            Divider(height: 0),
            RadioListTile<String>(
              title: Text('Schedule delivery'),
              subtitle: Text('Choose your preferred time'),
              value: 'scheduled',
            ),
          ],
        ),
  ...
  Widget _buildPriceSummary(CartProvider cartProvider, double totalPrice) {
    return Container(
      ...
      child: Column(
        children: [
          _buildPriceLine(label: 'Subtotal', price: cartProvider.totalPrice),
          const SizedBox(height: 8),
          _buildPriceLine(label: 'Delivery Fee', price: _deliveryFee),
          Divider(color: Colors.grey.shade300, height: 16),
          _buildPriceLine(label: 'Total', price: totalPrice, isBold: true),
        ],
      ),
    );
  }
