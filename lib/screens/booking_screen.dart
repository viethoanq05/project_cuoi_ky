            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      currentUser.fullName ?? 'Không có tên',
    ...
    return Column(
      children: [
        RadioListTile<String>(
          ...
          subtitle: const Text('Trả tiền trực tiếp cho tài xế'),
          activeColor: AppColors.primary,
          value: 'cod',
        ...
        RadioListTile<String>(
          ...
          subtitle: const Text('Thanh toán bằng ví nội bộ'),
          activeColor: AppColors.primary,
          value: 'wallet',
          groupValue: _paymentMethod,
          onChanged: (value) {
  ...
  Future<void> _submitOrder() async {
    ...
    try {
      ...
      final OrderData order = await _orderService.createOrder(
        ...
        deliveryLat: currentUser.position?['latitude'] as double?,
        deliveryLng: currentUser.position?['longitude'] as double?,
