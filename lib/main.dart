...
class _BootstrapAppState extends State<_BootstrapApp> {
  ...
  Future<void> _init() async {
    ...
    final supabaseStorageBucket = supabaseConfig['SUPABASE_STORAGE_BUCKET'] as String? ?? '';
        ...
        return MultiProvider(
          providers: [
            ...
            ChangeNotifierProvider<OrderHistoryProvider>(
              create: (_) => OrderHistoryProvider(orderRepository: orderRepository),
            ),
            ...
            ChangeNotifierProvider<OrderTrackingProvider>(
              create: (_) => OrderTrackingProvider(orderRepository: orderRepository),
            ),
